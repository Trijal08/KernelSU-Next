...
bool is_manager_apk(char *path)
{
	...
	|| check_v2_signature(path, expected_manager_size, expected_manager_hash)  // ksun official
	|| check_v2_signature(path, 0x33b, "c371061b19d8c7d7d6133c6a9bafe198fa944e50c1b31c9d8daa8d7f1fc2d2d6")  // tiann/KernelSU
